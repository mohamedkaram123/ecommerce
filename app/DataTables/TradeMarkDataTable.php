...
class TradeMarkDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('edit', 'admin.trademark.btn.edit')
            ->addColumn('delete', 'admin.trademark.btn.delete')
            ->addColumn('checkbox', 'admin.trademark.btn.checkbox')
            ->addColumn('logo', 'admin.trademark.btn.logo')
        ...
        return $this->builder()
                 ...
                 //   ->addAction(['width' => '80px'])
                    ->parameters([
                        ...
                        'buttons'=>[
                            ['action'=>'function(){
                                window.location.href = "'.aurl("trademark/create").'"
                            }','className'=>'btn btn-danger','text'=>'<i class="fa fa-plus" >'.trans("admin.addtrademark").'</i>'],
