...
class MallDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ...
            ->addColumn('logo', 'admin.mall.btn.logo')
            ->addColumn('logo', 'admin.mall.btn.country')
        ...
        return $this->builder()
                 ...
                 //   ->addAction(['width' => '80px'])
                    ->parameters([
                        ...
                        'buttons'=>[
                            ['action'=>'function(){
                                window.location.href = "'.aurl("mall/create").'"
                            }','className'=>'btn btn-danger','text'=>'<i class="fa fa-plus" >'.trans("admin.addmall").'</i>'],
