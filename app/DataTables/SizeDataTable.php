...
class SizeDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ...
            ->addColumn('department_id', 'admin.size.btn.department_id')
        ...
        return $this->builder()
                 ...
                 //   ->addAction(['width' => '80px'])
                    ->parameters([
                        ...
                        'buttons'=>[
                            ['action'=>'function(){
                                window.location.href = "'.aurl("size/create").'"
                            }','className'=>'btn btn-danger','text'=>'<i class="fa fa-plus" >'.trans("admin.addsize").'</i>'],
