...
<div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
            {!! Form::open(['route'=>'cites.store',"files"=>true]) !!}
 <div class="form-group">
     {!! Form::label('cites_name_ar',trans('admin.cites_name_ar')) !!}
     {!! Form::text("cites_name_ar",old('cites_name_ar'),['class'=>'form-control']) !!}
</div>

<div class="form-group">
     {!! Form::label('cites_name_en',trans('admin.cites_name_en')) !!}
     {!! Form::text("cites_name_en",old('cites_name_en'),['class'=>'form-control']) !!}
</div>

<div class="form-group">
     {!! Form::label('contries_id_name',trans('admin.contries_id_name')) !!}
     {!! Form::select("contries_id",country_id(),['class'=>'form-control']) !!}
</div>
