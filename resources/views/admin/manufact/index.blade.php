      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6 rightable">
            <h1>{{ trans("admin.dataTablesmanufact") }}</h1>
            @if(session("success"))
...
<div class="card">
            <div class="card-header">
              <h3 class="card-title rightable">{{ trans('admin.menufactcontroller') }}</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body  ">
             {!! Form::open(['id'=>'form_data','url'=>aurl('manufact/destroy/all'),"method"=>"delete"]) !!}

              {!! $dataTable->table(['class'=> 'dataTable  table-responsive table content table-striped table-bordered  table-hover '],true) !!}
