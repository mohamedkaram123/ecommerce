...
$(document).ready(function(){
  $('#jstree').jstree({
  "core" : {
    'data' : {!! load_dep($data->parent,$data->id) !!},
    "themes" : {
      "variant" : "large"
    }
  },
...
<div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
            {!! Form::open(['route'=>['department.update',$data->id],"method"=>"PUT","files"=>true]) !!}
 <div class="form-group">
     {!! Form::label('dep_name_ar',trans('admin.dep_name_ar')) !!}
     {!! Form::text("dep_name_ar",$data->dep_name_ar,['class'=>'form-control']) !!}
</div>

<div class="form-group">
     {!! Form::label('dep_name_en',trans('admin.dep_name_en')) !!}
     {!! Form::text("dep_name_en",$data->dep_name_en,['class'=>'form-control']) !!}
</div>
<div class="clearfix">
...
<div class="form-group">
     ...
     {!! Form::textarea("keywords",$data->keywords,['class'=>'form-control']) !!}
</div>
...
<div class="form-group">
    {!! Form::label('icon',trans('admin.dep_icon')) !!}
     ...
     @if($data->icon)
<img src="{{Storage::url($data->icon)}}" style="width:50px;height:50px;" />
     @endif
