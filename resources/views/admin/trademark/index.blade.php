      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6 rightable">
            <h1>{{ trans("admin.dataTablestrademark") }}</h1>
            @if(session("success"))
...
<div class="card">
            <div class="card-header">
              <h3 class="card-title rightable">{{ trans('admin.trademarkcontroller') }}</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
             {!! Form::open(['id'=>'form_data','url'=>aurl('trademark/destroy/all'),"method"=>"delete"]) !!}
    
              {!! $dataTable->table(['class'=> 'dataTable  table content table-striped table-bordered  table-hover col-10'],true) !!}
               {!! Form::close() !!}
            </div>
            <!-- /.card-body -->
          </div>
