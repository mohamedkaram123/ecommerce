      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6 rightable">
            <h1>{{ trans("admin.dataTablessize") }}</h1>
            @if(session("success"))
...
<div class="card">
            <div class="card-header">
              <h3 class="card-title rightable">{{ trans('admin.sizecontroller') }}</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
             {!! Form::open(['id'=>'form_data','url'=>aurl('size/destroy/all'),"method"=>"delete"]) !!}
